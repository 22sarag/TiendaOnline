            ...
            <div class="bg-white p-10 md:w-3/4 lg:w-1/2 mx-auto">
              ...
              <form action="{{route('proveedors.update', $proveedor)}}" method="POST">
                ...
                <div class="flex items-center mb-5">
                  ...
                  <input value="{{old('name', $proveedor->name)}}" type="text" name="name" placeholder="Nombre del Proveedor" 
                ...
                <div class="flex items-center mb-5">
                  ...
                  <input value="{{old('ci', $proveedor->ci)}}" type="text" name="ci" placeholder="Carnet de Identidad del Proveedor" 
                         class="flex-1 py-2 border-b-2 border-gray-400 focus:border-indigo-400 
                                text-gray-600 placeholder-gray-400
                                outline-none">
                </div>                                    
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input value="{{old('ciudad', $proveedor->ciudad)}}" type="text" name="ciudad" placeholder="Ciudad del Proveedor" 
                           class="flex-1 py-2 border-b-2 border-gray-400 focus:border-indigo-400 
                                  text-gray-600 placeholder-gray-400
                                  outline-none">
                </div>
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input value="{{old('telefono', $proveedor->telefono)}}" type="text" name="telefono" placeholder="Carnet de Identidad del Proveedor" 
                           class="flex-1 py-2 border-b-2 border-gray-400 focus:border-indigo-400 
                                  text-gray-600 placeholder-gray-400
                                  outline-none">
                </div>
                ...
                <div class="flex items-center mb-5">
                    ...
                    <input value="{{old('direccion', $proveedor->direccion)}}" type="text" name="direccion" placeholder="Carnet de Identidad del Proveedor" 
                           class="flex-1 py-2 border-b-2 border-gray-400 focus:border-indigo-400 
                                  text-gray-600 placeholder-gray-400
                                  outline-none">
                </div>
